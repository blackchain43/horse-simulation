...
def simulate_race(
    ...
    horse_positions = [
        [initial_positions[horse] if initial_positions else 0 for horse in range(num_horses)] for _ in range(num_rounds)
        ]
    ...
    for round_num in range(num_rounds):
        round_positions = []
        round_acc_points = []
        # print(f"Position before: {horse_positions[round_num]}")
